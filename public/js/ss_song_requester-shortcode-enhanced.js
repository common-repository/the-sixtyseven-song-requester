(function( $ ) {
	...
	$(function() {
	   //alert('loaded');
        ...
        var ss_request_form = $('.ss_song_requester_request');
        var reload_in_seconds = ss_song_requester_jsvars.autoreload_seconds;
        var countdown_running = true;
        var countdown_pause = $('#countdown_pause');
        var countdown_resume = $('#countdown_resume').hide();
        ...
        $( ss_request_list ).on( 'click', '#countdown_pause', function() {
            ss_countdown_pause();
        });
                                
       $( ss_request_list ).on( 'click', '#countdown_resume', function() {
            ss_countdown_resume();
        });
        ...
        function ss_countdown_pause(){
            countdown_running = false;
            countdown_pause.hide();
            countdown_resume.show();
        }
        
        function ss_countdown_resume(){
            countdown_running = true;
            countdown_pause.show();
            countdown_resume.hide();
        }
